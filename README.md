...
[![Go Reference](https://pkg.go.dev/badge/github.com/fmotalleb/acme-server.svg)](https://pkg.go.dev/github.com/fmotalleb/acme-server)
[![go.mod](https://img.shields.io/github/go-mod/go-version/fmotalleb/acme-server)](go.mod)
[![LICENSE](https://img.shields.io/github/license/fmotalleb/acme-server)](LICENSE)
[![Go Report Card](https://goreportcard.com/badge/github.com/fmotalleb/acme-server)](https://goreportcard.com/report/github.com/fmotalleb/acme-server)
[![Codecov](https://codecov.io/gh/fmotalleb/acme-server/branch/main/graph/badge.svg)](https://codecov.io/gh/fmotalleb/acme-server)
...
1. Replace all occurrences of `fmotalleb/acme-server` to `your_org/repo_name` in all files.
